...
const i18n = {
  en: {
    ...
    intro_body:'A space where the body becomes language.<br>Where light constructs silence.<br>Where each image holds what words cannot reach.',
  ...
  fr: {
    ...
    intro_body:'Un espace où le corps devient langage.<br>Où la lumière construit le silence.<br>Où chaque image garde ce que les mots ne peuvent pas atteindre.',
  ...
  es: {
    ...
    intro_body:'Un espacio donde el cuerpo se convierte en lenguaje.<br>Donde la luz construye silencio.<br>Donde cada imagen guarda lo que las palabras no alcanzan.',
